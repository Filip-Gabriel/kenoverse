...
class AppTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFD240CA),
      surfaceTint: Color(0xFFD240CA),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFFff90ff),
      onPrimaryContainer: Color(0xFFaa18a2),
      secondary: Color(0xFF2CC0C7),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF7cffff),
      onSecondaryContainer: Color(0xFF04989f),
      tertiary: Color(0xFF24C9D1),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF74ffff),
      onTertiaryContainer: Color(0xFF00a1a9),
      ...
      inversePrimary: Color(0xFFbe2cb6),
      primaryFixed: Color(0xFFff90ff),
      onPrimaryFixed: Color(0xFF96048e),
      primaryFixedDim: Color(0xFFff7cff),
      onPrimaryFixedVariant: Color(0xFFbe2cb6),
      secondaryFixed: Color(0xFF7cffff),
      onSecondaryFixed: Color(0xFF00848b),
      secondaryFixedDim: Color(0xFF68fcff),
      onSecondaryFixedVariant: Color(0xFF18acb3),
      tertiaryFixed: Color(0xFF74ffff),
      onTertiaryFixed: Color(0xFF008d95),
      tertiaryFixedDim: Color(0xFF60ffff),
      onTertiaryFixedVariant: Color(0xFF10b5bd),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xFFbe2cb6),
      surfaceTint: Color(0xFFbe2cb6),
      onPrimary: Color(0xFFFFFFFF),
      primaryContainer: Color(0xFF96048e),
      onPrimaryContainer: Color(0xFFFFFFFF),
      secondary: Color(0xFF18acb3),
      onSecondary: Color(0xFF000000),
      secondaryContainer: Color(0xFF00848b),
      onSecondaryContainer: Color(0xFF000000),
      tertiary: Color(0xFF10b5bd),
      onTertiary: Color(0xFF000000),
      tertiaryContainer: Color(0xFF008d95),
      ...
      inversePrimary: Color(0xFFD240CA),
      primaryFixed: Color(0xFFff90ff),
      onPrimaryFixed: Color(0xFF96048e),
      primaryFixedDim: Color(0xFFff7cff),
      onPrimaryFixedVariant: Color(0xFFbe2cb6),
